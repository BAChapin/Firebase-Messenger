...
let ContentsLayerName = "ContentLayer"
...
extension UIView {
    ...
    func shadow(withOpacity opacity: Float = 0.2, radius: CGFloat = 5, offset: CGSize = .init(width: 0, height: 5)) {
        layer.addShadow(opacity: opacity, radius: radius, offset: offset)
    }
